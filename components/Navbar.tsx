...
const Navbar = () => (
  ...
  >
    ...
    >
      ...
      />
      <h2 className="font-regular text-[24px] leading-[30.24px] text-white flex justify-center items-center">
        Citizen Corrects
      </h2>
      <div>
        <a href="https://citizencorrects.com/login" target="_blank" rel="noreferrer">
          <button
            type="button"
